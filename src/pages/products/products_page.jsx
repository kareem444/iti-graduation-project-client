    ...
    <div className="container mt-5">
      <div className="flex-w flex-sb-m p-b-52">
        <div className="flex-w flex-l-m filter-tope-group m-tb-10">
          <button
            className="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 RobotoFont"
        ...
        <div className=" m-tb-10 d-flex col-12 col-md-4 ">
          <input
            type="text"
            className="border w-100 product_page_input_search rounded RobotoFont"
            placeholder="Search"
                ...
                <div className="block2">
                  <div className="block2-pic hov-img0 rounded border">
                    ...
                    <Link
                      ...
                      className="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 p-lr-15 trans-04 js-show-modal1 on-hover-btn RobotoFont"
                    >
                      More Details
                    </Link>
                  </div>
                  <div className="block2-txt flex-w flex-t p-t-14">
                    <div className="block2-txt-child1 flex-col-l ">
                      <p
                        ...
                        className="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6 col-12 text-truncate RobotoFont"
                      >
                        {product.title}
                      </p>
                      <StarRatings
