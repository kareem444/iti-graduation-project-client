...
const AdminProducts = () => {
  ...
  const { data: products, isLoading, isError, error,refetch } = RepoGetAllProducts();

  const handleClickOpen = (id) => {
    setProductId(id)
    setOpen(true);
  };
  const { mutate, isError: IsMutateError, error: mutateError, isLoading: isMutateLoading,isSuccess } = RepoDeleteProduct()
  const handleClose = (e) => {
  ...
  const columns = [
    {
      ...
      renderCell: (index) =>{ return (
        <Box
          display="flex"
        >
          <Typography color={colors.grey[100]} sx={{ ml: "0px" }}component={Link} to={`../adminproductdetails/${products[index.api.getRowIndex(index.row["_id"])]["_id"]}`}  >
      ...
      renderCell: (index) => {
        ...
        return (
          ...
          >
            ...
            <Box m="0 0 0 10px" component={Link} to={`../admineditproduct/${products[index.api.getRowIndex(index.row["_id"])]['_id']}`}>
              <EditIcon
                sx={{
                  cursor: "pointer",
            ...
            <Box m="0 0 0 10px" component={Link} to={`../adminproductdetails/${products[index.api.getRowIndex(index.row["_id"])]['_id']}`}>
              <VisibilityIcon
                sx={{
                  cursor: "pointer",
                  color: colors.grey[100],
